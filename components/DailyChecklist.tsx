                ...
                <div className="text-center md:text-left h-full flex flex-col justify-center">
                    {isComplete ? (
                        <div className="animate-fade-in-up">
                            ...
                            <a href="https://whop.com/koko-market-journal/kmj-public/" target="_blank" rel="noopener noreferrer" className="inline-block px-8 py-4 bg-white text-black font-bold rounded-xl hover:bg-gray-200 transition-all shadow-[0_0_20px_rgba(255,255,255,0.2)]">
                                Enter the Market
                            </a>
                        </div>
                    ) : (

...
const FAQ: React.FC = () => {
  ...
  const col1 = [
    ...
    },
    {
      ...
      answer: "Currently, NO. Everything I know is available in the community for free. I might offer advanced 1-on-1 coaching in the future for those who want to accelerate their curve, but the core education will always remain accessible."
    }
  ];
